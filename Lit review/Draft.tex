...
The final runtimes of both meshes were very similar to the ones previously obtained, as shown in Figure /ref{fig:compareTimes}. Because of this, we can be sure that our version of the solver is the same as the final one used by the previous authors during their theses. 
