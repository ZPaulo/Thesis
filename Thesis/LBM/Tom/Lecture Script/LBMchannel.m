...
% variables===========================description==========================
tmax   = 40000;                     % total amount of timesteps
t      = 1;                         % first timestep, default=1
eps    = 10e-4;                     % convergence criterion (L2 norm)
...
% ===== apply Zou-He BC on boundary edges =================================
    ...
    for j=2:ny-1
        i = nx;
        rtemp = 1;
        utemp = ((fn1(i,j,1)+fn1(i,j,3)+fn1(i,j,5)+2*(fn1(i,j,2)+fn1(i,j,6)+fn1(i,j,9)))/rtemp)-1;
        vtemp = 0;      
...
% % %         
% % %         % microscopic boundary conditions
% % %         fn1(i,j,4) = fn1(i-1,j,4);
% % %         fn1(i,j,8) = fn1(i-1,j,8);
% % %         fn1(i,j,7) = fn1(i-1,j,7);
% % %         
% % %         % macroscopic boundary conditions
% % %         fsum  = 0;
% % %         utemp = 0;
