...
\begin{listofabbreviations}
	\abbrev{2D}{Two dimensions}
	\abbrev{3D}{Three dimensions}
    ...
    \abbrev{2DQ9}{Lattice speed model used for 2D}
    \abbrev{3DQ19}{Lattice speed model used for 3D}
    \abbrev{HPC}{High Performance Computing}
    \abbrev{BGKW}{Bhatnagar-Gross-Krook-Welander collision model}
    \abbrev{TRT}{Two Relaxation Time collision model}
    \abbrev{MRT}{Multiple Relaxation Time collision model}
    \abbrev{MB}{Mega Bytes}
